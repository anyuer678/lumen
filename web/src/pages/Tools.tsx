...
export default function Tools() {
  ...
  const preset = (tool: ToolMeta) => {
    switch (tool.name) {
      ...
      case 'fs.organize': return JSON.stringify({ action: 'organize', path: C:\Users\30816 + '/Downloads' }, null, 2)
      case 'fs': return JSON.stringify({ action: 'organize', path: C:\Users\30816 + '/Downloads' }, null, 2)
